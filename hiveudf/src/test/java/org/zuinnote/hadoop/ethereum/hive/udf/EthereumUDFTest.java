...
public class EthereumUDFTest {
	...
	static final int DEFAULT_MAXSIZE_ETHEREUMBLOCK=1 * 1024 * 1024;
	  ...
	  public void EthereumGetChainIdUDFNull() throws HiveException {
		...
		assertNull("Null argument to UDF returns null",egcidUDF.evaluate(null));
	  }
	  ...
	  public void EthereumGetSendAddressUDFNull() throws HiveException {
		...
		assertNull("Null argument to UDF returns null",egsaUDF.evaluate(null));
	  }
	  ...
	  public void EthereumGetTransactionHashUDFNull() throws HiveException {
		...
		assertNull("Null argument to UDF returns null",egthUDF.evaluate(null));
	  }
	  ...
	  public void EthereumGetChainIdUDFWritable() throws HiveException, IOException, EthereumBlockReadException {
		  ...
		  ClassLoader classLoader = getClass().getClassLoader();
			...
			try {
				...
				assertNull("Block 1346406 Transaction 1 is Ethereum MainNet",egcidUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans0)}));
				EthereumTransaction trans1 = eTrans.get(1);
				assertNull("Block 1346406 Transaction 2 is Ethereum MainNet",egcidUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans1)}));
				EthereumTransaction trans2 = eTrans.get(2);
				assertNull("Block 1346406 Transaction 3 is Ethereum MainNet",egcidUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans2)}));
				EthereumTransaction trans3 = eTrans.get(3);
				assertNull("Block 1346406 Transaction 4 is Ethereum MainNet",egcidUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans3)}));
				EthereumTransaction trans4 = eTrans.get(4);
				assertNull("Block 1346406 Transaction 5 is Ethereum MainNet",egcidUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans4)}));
				EthereumTransaction trans5 = eTrans.get(5);
				assertNull("Block 1346406 Transaction 6 is Ethereum MainNet",egcidUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans5)}));
			}
			 finally {
				if (ebr!=null) {
					ebr.close();
			...
			try {
				...
				// validate UDFs
				 ...
				 EthereumTransaction trans0 = eTrans.get(0);
			      ...
			      assertArrayEquals("Block 1346406 Transaction 1 send address is correctly calculated",expectedSentAddress,((BytesWritable)egsaUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans0)})).copyBytes());
			      EthereumTransaction trans1 = eTrans.get(1);
			      ...
			      assertArrayEquals("Block 1346406 Transaction 2 send address is correctly calculated",expectedSentAddress,((BytesWritable)egsaUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans1)})).copyBytes());
			      EthereumTransaction trans2 = eTrans.get(2);
			      ...
			      assertArrayEquals("Block 1346406 Transaction 3 send address is correctly calculated",expectedSentAddress,((BytesWritable)egsaUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans2)})).copyBytes());
			      EthereumTransaction trans3 = eTrans.get(3);
			      expectedSentAddress = new byte[] {(byte)0x63,(byte)0xa9,(byte)0x97,(byte)0x5b,(byte)0xa3,(byte)0x1b,(byte)0x0b,(byte)0x96,(byte)0x26,(byte)0xb3,(byte)0x43,(byte)0x00,(byte)0xf7,(byte)0xf6,(byte)0x27,(byte)0x14,(byte)0x7d,(byte)0xf1,(byte)0xf5,(byte)0x26};
			     assertArrayEquals("Block 1346406 Transaction 4 send address is correctly calculated",expectedSentAddress,((BytesWritable)egsaUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans3)})).copyBytes());
			      EthereumTransaction trans4 = eTrans.get(4);
			      expectedSentAddress = new byte[] {(byte)0x63,(byte)0xa9,(byte)0x97,(byte)0x5b,(byte)0xa3,(byte)0x1b,(byte)0x0b,(byte)0x96,(byte)0x26,(byte)0xb3,(byte)0x43,(byte)0x00,(byte)0xf7,(byte)0xf6,(byte)0x27,(byte)0x14,(byte)0x7d,(byte)0xf1,(byte)0xf5,(byte)0x26};
			      assertArrayEquals("Block 1346406 Transaction 5 send address is correctly calculated",expectedSentAddress,((BytesWritable)egsaUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans4)})).copyBytes());
			      EthereumTransaction trans5 = eTrans.get(5);
			      expectedSentAddress = new byte[] {(byte)0x63,(byte)0xa9,(byte)0x97,(byte)0x5b,(byte)0xa3,(byte)0x1b,(byte)0x0b,(byte)0x96,(byte)0x26,(byte)0xb3,(byte)0x43,(byte)0x00,(byte)0xf7,(byte)0xf6,(byte)0x27,(byte)0x14,(byte)0x7d,(byte)0xf1,(byte)0xf5,(byte)0x26};
			      assertArrayEquals("Block 1346406 Transaction 6 send address is correctly calculated",expectedSentAddress,((BytesWritable)egsaUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans5)})).copyBytes());
	  ...
	  public void EthereumGetTransactionHashUDFWritable() throws HiveException, IOException, EthereumBlockReadException {
		  ...
		  ClassLoader classLoader = getClass().getClassLoader();
			...
			try {
				...
				assertArrayEquals("Block 1346406 Transaction 1 hash is correctly calculated",expectedHash,((BytesWritable)egthUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans0)})).copyBytes());
				EthereumTransaction trans1 = eTrans.get(1);
				...
				assertArrayEquals("Block 1346406 Transaction 2 hash is correctly calculated",expectedHash,((BytesWritable)egthUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans1)})).copyBytes());
				EthereumTransaction trans2 = eTrans.get(2);
				...
				assertArrayEquals("Block 1346406 Transaction 3 hash is correctly calculated",expectedHash,((BytesWritable)egthUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans2)})).copyBytes());
				EthereumTransaction trans3 = eTrans.get(3);
				...
				assertArrayEquals("Block 1346406 Transaction 4 hash is correctly calculated",expectedHash,((BytesWritable)egthUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans3)})).copyBytes());
				EthereumTransaction trans4 = eTrans.get(4);
				...
				assertArrayEquals("Block 1346406 Transaction 5 hash is correctly calculated",expectedHash,((BytesWritable)egthUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans4)})).copyBytes());
				EthereumTransaction trans5 = eTrans.get(5);
				...
				assertArrayEquals("Block 1346406 Transaction 6 hash is correctly calculated",expectedHash,((BytesWritable)egthUDF.evaluate(new GenericUDF.DeferredObject[] {new GenericUDF.DeferredJavaObject(trans5)})).copyBytes());
