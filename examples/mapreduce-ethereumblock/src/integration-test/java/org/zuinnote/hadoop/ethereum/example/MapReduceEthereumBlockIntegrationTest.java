...
private ArrayList<Decompressor> openDecompressors = new ArrayList<>();
   ...
   @BeforeClass
    ...
    public void mapReduceBlock1346406() throws IOException, Exception {
  	...
  	int res = ToolRunner.run(miniCluster.getConfig(), new EthereumBlockCounterDriver(), new String[]{DFS_INPUT_DIR_NAME,DFS_OUTPUT_DIR_NAME}); 
	...
	assertEquals("Number of transactions is 6","Transaction Count:\t6",resultLines.get(0));
    }
