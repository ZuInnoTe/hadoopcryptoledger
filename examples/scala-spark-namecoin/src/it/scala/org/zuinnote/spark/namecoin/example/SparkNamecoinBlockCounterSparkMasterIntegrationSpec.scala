...
package org.zuinnote.spark.namecoin.example
...
class SparkNamecoinBlockCounterSparkMasterIntegrationSpec extends AnyFlatSpec with BeforeAndAfterAll with GivenWhenThen with Matchers {
 
private var sc: SparkContext = _
private val master: String = "local[2]"
private val appName: String = "example-scalasparknamecoinblockcounter-integrationtest"
...
"The genesis block on DFS" should "be 1 transactions i total" in {
	...
	val classLoader = getClass().getClassLoader()
    	// put testdata on DFS
    	val fileName: String="namecoingenesis.blk"
